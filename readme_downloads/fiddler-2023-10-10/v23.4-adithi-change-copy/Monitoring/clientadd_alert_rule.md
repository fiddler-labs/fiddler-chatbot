...
updatedAt: "2023-08-01T13:49:27.896Z"
---
[block:parameters]
{
  "data": {
    ...
    "1-1": "str",
    "1-2": "None",
    "1-3": "`Deprecated` The unique identifier for the project.",
    "2-0": "model_id",
    "2-1": "str",
    "2-2": "None",
    "2-3": "`Deprecated` The unique identifier for the model.",
    "3-0": "alert_type",
    ...
    "15-1": "str",
    "15-2": "None",
    "15-3": "The unique identifier for the project.",
    "16-0": "model_name",
    "16-1": "str",
    "16-2": "None",
    "16-3": "The unique identifier for the model.",
    "17-0": "baseline_name",
    "17-1": "str",
    "17-2": "None",
    "17-3": "Name of the baseline whose histogram is compared against the same derived from current data. When no baseline_id is specified then the [default baseline](doc:fiddler-baselines) is used.  \n  \nUsed only when alert type is `AlertType.DATA_DRIFT`.",
    "18-0": "columns",
    "18-1": "Optional\\[List[str]]",
    "18-2": "None",
    "18-3": "List of column names on which alert rule is to be created."
  },
  "cols": 4,
  "rows": 19,
  "align": [
