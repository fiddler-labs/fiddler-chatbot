...
updatedAt: "2023-01-12T18:02:07.600Z"
---
[block:parameters]
{
  "data": {
    ...
    "3-0": "alert_type",
    "3-1": "[fiddler.AlertType](https://docs.fiddler.ai/v1.5/reference/fdlalerttype)",
    "3-2": "None",
    "3-3": "One of `AlertType.PERFORMANCE`,  \n`AlertType.DATA_DRIFT`,  \n`AlertType.DATA_INTEGRITY`, or `AlertType.SERVICE_METRICS`.",
    "4-0": "metric",
    "4-1": "[fiddler.Metric](https://docs.fiddler.ai/v1.5/reference/fdlmetric)",
    "4-2": "None",
    ...
    "5-0": "bin_size",
    "5-1": "[fiddler.BinSize](https://docs.fiddler.ai/v1.5/reference/fdlbinsize)",
    "5-2": "ONE_DAY",
    "5-3": "Duration for which the metric value is calculated. Choose one of the following:  \n`BinSize.ONE_HOUR`  \n`BinSize.ONE_DAY` `BinSize.SEVEN_DAYS`",
    "6-0": "compare_to",
    "6-1": "[fiddler.CompareTo](https://docs.fiddler.ai/v1.5/reference/fdlcompareto)",
    "6-2": "None",
    ...
    "7-0": "compare_period",
    "7-1": "[fiddler.ComparePeriod](https://docs.fiddler.ai/v1.5/reference/fdlcompareperiod)",
    "7-2": "None",
    ...
    "8-0": "priority",
    "8-1": "[fiddler.Priority](https://docs.fiddler.ai/v1.5/reference/fdlpriority)",
    "8-2": "None",
    "8-3": "`Priority.LOW`  \n`Priority.MEDIUM`  \n`Priority.HIGH`",
    ...
    "11-0": "condition",
    "11-1": "[fiddler.AlertCondition](https://docs.fiddler.ai/v1.5/reference/fdlalertcondition)",
    "11-2": "None",
