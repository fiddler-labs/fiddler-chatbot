...
updatedAt: "Wed Jan 17 2024 23:51:13 GMT+0000 (Coordinated Universal Time)"
---
...
![](https://files.readme.io/0cc61d5-image.png)

#### Step 2 - Access Model Insights

Once the production events are published, we can monitor a variety of model metrics by leveraging the models default dashboard. To access the default dashboard, click on the Insights button for a model on the homepage or model schema page. This will display a series of data drift, performance, traffic and data integrity time series charts for your model. 

![](https://files.readme.io/187e626-image.png)
...
![](https://files.readme.io/dd5f2fe-image.png)
...
#### Step 6 - Check the impact of drift
